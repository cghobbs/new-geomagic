...
export const allFaqItems: FaqItem[] = [
  {
    ...
    answer:
      'Yes. I perform across Greater Vancouver — Vancouver, Burnaby, Richmond, North & West Vancouver, New Westminster, Tri-Cities, Langley, White Rock, and surrounding areas. Include your venue or city in the inquiry form.',
  },
  {
    question: 'How far in advance should I book?',
    answer:
      'Weekends and wedding season dates can book quickly. As soon as you have a date and rough guest count, reach out — I’ll confirm availability and suggested performance timing.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Most bookings are timed to cocktail-style mingling (often 1–2 hours) or a reception window. Larger guest counts may benefit from a longer block — we’ll map it to your run-of-show.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Every event is a little different — I’ll quote based on date, location, timing, and guest count after you submit the inquiry form.',
  },
];
